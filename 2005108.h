// Header extracted from the original implementation to provide consistent
// class definitions for all translation units.
...
static inline unsigned long long sdbm(const string &str)
{
